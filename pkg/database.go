...
func (pg *Postgres) InsertFCF(ctx context.Context, ticker string, cashFlow2020, cashFlow2021, cashFlow2022, cashFlow2023, InterestExpense2023, TotalDebt2023 string) error {
	var err error
	...
	interestexpense, err := strconv.Atoi(InterestExpense2023)
	if err != nil {
		return fmt.Errorf("failed to convert InterestExpense2023 to integer: %v", err)
	}

	totaldebt, err := strconv.Atoi(TotalDebt2023)
	if err != nil {
